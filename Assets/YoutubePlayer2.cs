...
namespace YoutubePlayer
{
    ...
    public class YoutubePlayer2 : MonoBehaviour
    {
        public enum Cli
        {
            YoutubeDl,
        ...
        /// <summary>
        /// List of Youtube urls (e.g. https://www.youtube.com/watch?v=VIDEO_ID)
        /// </summary>
        public List<string> youtubeUrls = new List<string>() { "https://youtu.be/nCoAmfVoMxo" }; // Default to one URL for now
        ...
        {
            currentUrlIndex++;
            if (currentUrlIndex < youtubeUrls.Count)
            {
                PlayVideoAsync(youtubeUrls[currentUrlIndex]);  // Play the next video
            }
        }
        ...
        {
            videoUrl = videoUrl ?? youtubeUrls[currentUrlIndex];
            ...
            youtubeUrls[currentUrlIndex] = videoUrl;
